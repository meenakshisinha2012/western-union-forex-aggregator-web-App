...
const { add_fx_rate, getFxProvider,getFxProviderFilterSellRateDesc,getFxProviderFilterBuyRateDesc,getFXProviderById } = require("../../controllers/fx-provider/fx-rate");
...
// router.get("/get-fx-provider/:fxProviderID", getFXProviderById)
